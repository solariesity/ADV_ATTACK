...
REALISTIC_WEIGHT=(0 0)
LOG_POSTFIX="mono_car_Rob_disp"
BASELINE="proposed"
STYLE_LAMBDA=2
END_LEARNING_RATE=(0.014 0.014)
DECAY_STEPS=0.8
DECAY_POWER=(2 2)
DEVICE=1
NPS_WEIGHT=(0.000000001 0.000000001)
COLOR_WEIGHT=(38 38)
COLOR_WEIGHT_14=(3.8 3.8)
COLOR_WEIGHT_2356=(38 38)
ORIGINAL_WEIGHT=(0 0)
FIXED_LOCATION=1
CLASS_LAMBDA=(0.0000000001 0.0000000001)
MIDU_WEIGHT=(50 50)


LOG_DIR="/home/hyj/code/ADV_ATTACK/DeepPhotoStyle_pytorch/log/log2026/05/log0508/lr_203/lr_scan_${CONTENT_IMAGE}_${STYLE_IMAGE}_${PAINT_MASK}"
...
bash /home/hyj/code/ADV_ATTACK/DeepPhotoStyle_pytorch/run2026/05/run0508_203_2.sh
