...
LABEL_PREFIX="america_bmw_pm34_cw2356"
LABEL_PARAM=(
    "cw14_0_cw2356_1"
    "cw14_0_cw2356_10"
    "cw14_0_cw2356_100"
...
CONTENT_WEIGHT=(0 0 0 0 0)
ADV_TYPE="yolo"
ADV_WEIGHT=(1 1 1 1 1)
TV_WEIGHT=(0 0 0 0 0)
BATCH_SIZE=6
...
BASELINE="proposed"
STYLE_LAMBDA=2
END_LEARNING_RATE=(0.02 0.02 0.02 0.02 0.02)
DECAY_STEPS=(0.8 0.8 0.8 0.8 0.8)
DECAY_POWER=(1.5 1.5 1.5 1.5 1.5)
NPS_WEIGHT=(0.0001 0.0001 0.0001 0.0001 0.0001)
FIXED_LOCATION=1
CLASS_LAMBDA=(0.0000000001 0.0000000001 0.0000000001 0.0000000001 0.0000000001)
RANDOM_SCENE=(0 0 0 0 0)
COLOR_POWER=2
OFFICIAL_YOLO_TENSOR=1
MIDU_WEIGHT=(0 0 0 0 0)

STYLE_WEIGHT=(0 0 0 0 0)
MASK_WEIGHT=(0 0 0 0 0)
REALISTIC_WEIGHT=(0 0 0 0 0)
COLOR_WEIGHT=(0 0 0 0 0)
ORIGINAL_WEIGHT=(0 0 0 0 0)

DEVICE=0
COLOR_WEIGHT_14=(0 0 0 0 0)
COLOR_WEIGHT_2356=(1 10 100 500 1000)

CONTENT_TAG="${CONTENT_IMAGE%.*}"
EXPERIMENT_TAG="bmw_cw2356_scan"
