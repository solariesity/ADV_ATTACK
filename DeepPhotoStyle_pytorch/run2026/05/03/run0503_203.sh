...
COLOR_WEIGHT=(26 26 26 26 26 26 26 26)
...
LOG_DIR="/home/hyj/code/ADV_ATTACK/DeepPhotoStyle_pytorch/log/log2026/05/log0503/ratio_203/ratio_scan_${CONTENT_IMAGE}_${STYLE_IMAGE}_${PAINT_MASK}"
