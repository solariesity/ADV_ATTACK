...
LABEL=(
    "ratio_scan_0090909_repeat_1"
    "ratio_scan_0090909_repeat_2"
    "ratio_scan_012_repeat_1"
    "ratio_scan_012_repeat_2"
    "ratio_scan_015_repeat_1"
    "ratio_scan_015_repeat_2"
    "ratio_scan_018_repeat_1"
    "ratio_scan_018_repeat_2"
)
...
COLOR_WEIGHT=(24 24 24 24 24 24 24 24)
COLOR_RATIO=(0.0909090909 0.0909090909 0.12 0.12 0.15 0.15 0.18 0.18)
...
LOG_DIR="/home/hyj/code/ADV_ATTACK/DeepPhotoStyle_pytorch/log/log2026/05/log0502/ratio_204/ratio_scan_${CONTENT_IMAGE}_${STYLE_IMAGE}_${PAINT_MASK}"
...
echo "ratio 扫描已完成，请检查日志目录 $LOG_DIR" >> "$LOG_FILE"
