...
COLOR_WEIGHT_14=(1.8 2.0 2.2 2.5 2.0 2.0 2.0 2.0)
...
MIDU_WEIGHT=(50 50 50 50 30 70 100 150)
RANDOM_SCENE=(0 0 0 0 0 0 0 0)


LOG_DIR="/home/hyj/code/ADV_ATTACK/DeepPhotoStyle_pytorch/log/log2026/05/log0511/color_203/color_scan_${CONTENT_IMAGE}_${STYLE_IMAGE}_${PAINT_MASK}"
...
echo "cw14 + midu 扫描已完成，请检查日志目录 $LOG_DIR" >> "$LOG_FILE"
bash /home/hyj/code/ADV_ATTACK/DeepPhotoStyle_pytorch/run2026/05/run0511_203_2.sh
