...
LOG_DIR="/home/hyj/code/ADV_ATTACK/DeepPhotoStyle_pytorch/log/log2026/05/log0511/color_203_2/color_scan_${CONTENT_IMAGE}_${STYLE_IMAGE}_${PAINT_MASK}"
...
echo "fixed_location=1 单轮实验已完成，请检查日志目录 $LOG_DIR" >> "$LOG_FILE"
