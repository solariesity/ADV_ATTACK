...
LOG_DIR="/home/hyj/code/ADV_ATTACK/DeepPhotoStyle_pytorch/log/log2026/05/log0512/color_203_3/color_scan_${CONTENT_IMAGE}_${STYLE_IMAGE}_${PAINT_MASK}"
...
echo "203轮 复刻实验已完成，请检查日志目录 $LOG_DIR" >> "$LOG_FILE"
