...
COLOR_WEIGHT_14=(1.8 2.3 2.7 3.2 3.6 4.1 4.5 5.0)
...
LOG_DIR="/home/hyj/code/ADV_ATTACK/DeepPhotoStyle_pytorch/log/log2026/05/log0506/color_203/color_scan_${CONTENT_IMAGE}_${STYLE_IMAGE}_${PAINT_MASK}"
