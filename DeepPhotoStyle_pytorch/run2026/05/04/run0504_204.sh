...
COLOR_RATIO=(0.18 0.18 0.18 0.18 0.18 0.18 0.18 0.18 0.18 0.18)
...
LOG_DIR="/home/hyj/code/ADV_ATTACK/DeepPhotoStyle_pytorch/log/log2026/05/log0504/ratio_204_ratio_scan_${CONTENT_IMAGE}_${STYLE_IMAGE}_${PAINT_MASK}"
...
echo "ratio=0.18 的 color_weight 扫描已完成，请检查日志目录 $LOG_DIR" >> "$LOG_FILE"
