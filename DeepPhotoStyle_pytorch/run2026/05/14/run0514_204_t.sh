...
LOG_DIR="/home/hyj/code/ADV_ATTACK/DeepPhotoStyle_pytorch/log/log2026/05/log0514/color_204_0_t/color_scan_${CONTENT_IMAGE}_${STYLE_IMAGE}_${PAINT_MASK}"
...
echo "0514 204_t cw14/cw2356 扫描已完成，请检查日志目录 $LOG_DIR" >> "$LOG_FILE"
