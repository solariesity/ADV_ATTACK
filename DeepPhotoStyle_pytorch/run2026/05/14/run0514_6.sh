...
LABEL_PARAM="lr0.1_midu0_cw14_10_cw2356_1000_6"
...
DEVICE=0
COLOR_WEIGHT_14=10
COLOR_WEIGHT_2356=1000

CONTENT_TAG="${CONTENT_IMAGE%.*}"
EXPERIMENT_TAG="bmw_color_scan"
...
RESULT_FILE="$LOG_DIR/6_${LABEL_PREFIX}_${LABEL_PARAM}.txt"
