...
BASELINE="proposed"
STYLE_LAMBDA=2
END_LEARNING_RATE=(0.02 0.02 0.02)
DECAY_STEPS=(0.8 0.8 0.8)
DECAY_POWER=(1.5 1.5 1.5)
NPS_WEIGHT=(0.0001 0.0001 0.0001)
FIXED_LOCATION=1
CLASS_LAMBDA=(0.0000000001 0.0000000001 0.0000000001)
RANDOM_SCENE=(0 0 0)
COLOR_POWER=2
OFFICIAL_YOLO_TENSOR=1
MIDU_WEIGHT=(50 50 50)
...
DEVICE=0
COLOR_WEIGHT_14=(3 3 3)
COLOR_WEIGHT_2356=(0 5 10)

CONTENT_TAG="${CONTENT_IMAGE%.*}"
EXPERIMENT_TAG="6_bmw_cw14_3_cw2356_0_5_10_midu50"
