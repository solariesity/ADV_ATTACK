...
LABEL_PARAM=(
    "cw14_0_cw2356_1_adam"
    "cw14_0_cw2356_2_adam"
    "cw14_0_cw2356_3_adam"
    "cw14_0_cw2356_5_adam"
)

LEARNING_RATE=(0.01 0.01 0.01 0.01)
CONTENT_WEIGHT=(0 0 0 0)
ADV_TYPE="yolo"
ADV_WEIGHT=(1 1 1 1)
TV_WEIGHT=(0 0 0 0)
BATCH_SIZE=6
...
BASELINE="proposed"
STYLE_LAMBDA=2
END_LEARNING_RATE=(0.02 0.02 0.02 0.02)
DECAY_STEPS=(0.8 0.8 0.8 0.8)
DECAY_POWER=(1.5 1.5 1.5 1.5)
NPS_WEIGHT=(0.0001 0.0001 0.0001 0.0001)
FIXED_LOCATION=1
...
DEVICE=0
COLOR_WEIGHT_14=(0 0 0 0)
COLOR_WEIGHT_2356=(1 2 3 5)

CONTENT_TAG="${CONTENT_IMAGE%.*}"
EXPERIMENT_TAG="12_bmw_cw14_0_cw2356_1_2_3_5_midu50_adam"
