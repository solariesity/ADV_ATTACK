...
EXPERIMENT_TAG="3_bmw_cw14_5_cw2356_5_rw_0.00227673_steps10000_lr0.003_cw_0_ow_0_midu50_adam"
...
for realistic_weight in "${REALISTIC_SWEEP[@]}"; do
    ...
    echo "启动实验 $idx，cw14=$CW14，cw2356=$CW2356，realistic_weight=$realistic_weight，steps=$STEPS，lr=$LEARNING_RATE，日志输出到 $RESULT_FILE" >> "$LOG_FILE"
    wait
