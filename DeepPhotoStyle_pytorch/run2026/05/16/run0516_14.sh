...
CW2356=5
CONTENT_WEIGHT=0
ORIGIN_SWEEP=(0.1 0.5 1 3 5)

CONTENT_TAG="${CONTENT_IMAGE%.*}"
EXPERIMENT_TAG="14_bmw_cw14_5_cw2356_5_cw_0_ow_0.1_0.5_1_3_5_midu50_adam"
...
idx=0
for origin_weight in "${ORIGIN_SWEEP[@]}"; do
    RESULT_FILE="$LOG_DIR/${idx}_${LABEL_PREFIX}_cw14_${CW14}_cw2356_${CW2356}_cw_${CONTENT_WEIGHT}_ow_${origin_weight}_adam.txt"
    ...
    echo "启动实验 $idx，cw14=$CW14，cw2356=$CW2356，content_weight=$CONTENT_WEIGHT，origin_weight=$origin_weight，日志输出到 $RESULT_FILE" >> "$LOG_FILE"
    wait
