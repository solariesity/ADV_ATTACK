...
CW_SWEEP=(5.5 6.5 7.5)
TV_SWEEP=(0 1e-6 1e-5 1e-4)

CONTENT_TAG="${CONTENT_IMAGE%.*}"
EXPERIMENT_TAG="7_bmw_cw14_5.5_6.5_7.5_cw2356_5.5_6.5_7.5_tvw_0_1e-6_1e-5_1e-4_midu50_adam"
...
idx=0
for cw_value in "${CW_SWEEP[@]}"; do
    for tv_value in "${TV_SWEEP[@]}"; do
        RESULT_FILE="$LOG_DIR/${idx}_${LABEL_PREFIX}_cw14_${cw_value}_cw2356_${cw_value}_tv_${tv_value}_adam.txt"
        ...
        echo "启动实验 $idx，cw14=cw2356=$cw_value，tv_weight=$tv_value，日志输出到 $RESULT_FILE" >> "$LOG_FILE"
        wait
