...
DEVICE=0
NPS_WEIGHT=0.001
COLOR_WEIGHT=(6000000 7000000 8000000 9000000 10000000 11000000 12000000 13000000)
...
LOG_DIR="/home/hyj/code/MDE_Attack/DeepPhotoStyle_pytorch/log2026/01/log0120/color_3/midu_weight_${MIDU_WEIGHT[0]}_${CONTENT_IMAGE}_${STYLE_IMAGE}_${PAINT_MASK}"
