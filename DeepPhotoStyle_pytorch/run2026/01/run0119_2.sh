...
DEVICE=1
NPS_WEIGHT=0.001
COLOR_WEIGHT=(2000000 3000000 4000000 6000000 9000000 13000000 17000000 20000000)
...
LOG_DIR="/home/hyj/code/MDE_Attack/DeepPhotoStyle_pytorch/log2026/01/log0119/color_2/midu_weight_${MIDU_WEIGHT[0]}_${CONTENT_IMAGE}_${STYLE_IMAGE}_${PAINT_MASK}"
