...
DEVICE=1
NPS_WEIGHT=0.001
COLOR_WEIGHT=(10000000 15000000 20000000 25000000 30000000 35000000 40000000 45000000)
...
LOG_DIR="/home/hyj/code/MDE_Attack/DeepPhotoStyle_pytorch/log2026/01/log0129/color_2/midu_weight_${MIDU_WEIGHT[0]}_${CONTENT_IMAGE}_${STYLE_IMAGE}_${PAINT_MASK}"
