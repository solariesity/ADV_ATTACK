...
DEVICE=0
NPS_WEIGHT=0.001
COLOR_WEIGHT=(5000000000 500000000000 50000000000000 5000000000 500000 500000 500000 500000)
ORIGINAL_WEIGHT=(1000000 1000000 1000000 1000000 1000000000000000000 1000000 1000000 1000000)
FIXED_LOCATION=1
...
LOG_DIR="/home/hyj/code/MDE_Attack/DeepPhotoStyle_pytorch/log0111/test_4/midu_weight_${MIDU_WEIGHT[0]}_${CONTENT_IMAGE}_${STYLE_IMAGE}_${PAINT_MASK}"
