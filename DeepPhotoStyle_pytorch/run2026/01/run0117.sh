...
DEVICE=0
NPS_WEIGHT=0.001
COLOR_WEIGHT=(200000000 2000000 2000000 2000000 2000000 2000000 2000000 2000000)
...
LOG_DIR="/home/hyj/code/MDE_Attack/DeepPhotoStyle_pytorch/log2026/01/log0117/total/midu_weight_${MIDU_WEIGHT[0]}_${CONTENT_IMAGE}_${STYLE_IMAGE}_${PAINT_MASK}"
