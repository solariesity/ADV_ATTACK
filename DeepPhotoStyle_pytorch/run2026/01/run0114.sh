...
CONTENT_WEIGHT=(30000 90000 300000 900000 3000000 9000000 30000000 90000000)
...
DEVICE=0
NPS_WEIGHT=0.001
COLOR_WEIGHT=(2000000 2000000 2000000 2000000 2000000 2000000 2000000 2000000)
...
LOG_DIR="/home/hyj/code/MDE_Attack/DeepPhotoStyle_pytorch/log0114/total/midu_weight_${MIDU_WEIGHT[0]}_${CONTENT_IMAGE}_${STYLE_IMAGE}_${PAINT_MASK}"
