...
CONTENT_WEIGHT=(30000 30000 30000 30000 30000 30000 30000 30000)
...
DEVICE=0
NPS_WEIGHT=0.001
COLOR_WEIGHT=(500000 550000 600000 650000 700000 750000 800000 850000)
ORIGINAL_WEIGHT=(10000000000 1000000000000 100000000000000 10000000000000000 1000000000000000000 1000000 1000000 1000000)
FIXED_LOCATION=1
...
LOG_DIR="/home/hyj/code/MDE_Attack/DeepPhotoStyle_pytorch/log0111/test_original/midu_weight_${MIDU_WEIGHT[0]}_${CONTENT_IMAGE}_${STYLE_IMAGE}_${PAINT_MASK}"
LOG_FILE="$LOG_DIR/color_weight_change_${PAINT_MASK}_${STEPS}.txt"
...
# 运行多个实验，输出到不同的日志文件
for i in {0,1,2,3}; do
    RESULT_FILE="$LOG_DIR/original_weight_${ORIGINAL_WEIGHT[$i]}_color_weight_${COLOR_WEIGHT[$i]}_${i}.txt"
