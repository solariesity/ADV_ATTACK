...
DEVICE=0
NPS_WEIGHT=0.001
COLOR_WEIGHT=(20000 60000 200000 600000 2000000 6000000 20000000 60000000)
...
LOG_DIR="/home/hyj/code/MDE_Attack/DeepPhotoStyle_pytorch/log2026/01/log0118/color_3/midu_weight_${MIDU_WEIGHT[0]}_${CONTENT_IMAGE}_${STYLE_IMAGE}_${PAINT_MASK}"
