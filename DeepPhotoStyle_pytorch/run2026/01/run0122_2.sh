...
DEVICE=1
NPS_WEIGHT=0.001
COLOR_WEIGHT=(3000000 6000000 12000000 20000000 40000000 80000000 160000000 200000000)
...
LOG_DIR="/home/hyj/code/MDE_Attack/DeepPhotoStyle_pytorch/log2026/01/log0122/color_2/midu_weight_${MIDU_WEIGHT[0]}_${CONTENT_IMAGE}_${STYLE_IMAGE}_${PAINT_MASK}"
