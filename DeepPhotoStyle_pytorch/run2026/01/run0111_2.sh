...
DEVICE=1
NPS_WEIGHT=0.001
COLOR_WEIGHT=(100000000000000000000000 550000 600000 650000 700000 750000 800000 850000)
...
LOG_DIR="/home/hyj/code/MDE_Attack/DeepPhotoStyle_pytorch/log0111/test1/midu_weight_${MIDU_WEIGHT[0]}_${CONTENT_IMAGE}_${STYLE_IMAGE}_${PAINT_MASK}"
