...
DEVICE=0
NPS_WEIGHT=0.001
COLOR_WEIGHT=(4000000 5000000 6000000 7000000 8000000 9000000 10000000 11000000)
...
LOG_DIR="/home/hyj/code/MDE_Attack/DeepPhotoStyle_pytorch/log2026/01/log0126/color_1/midu_weight_${MIDU_WEIGHT[0]}_${CONTENT_IMAGE}_${STYLE_IMAGE}_${PAINT_MASK}"
