...
DEVICE=1
NPS_WEIGHT=0.001
COLOR_WEIGHT=(3000000 5000000 7000000 10000000 12000000 15000000 17000000 20000000)
...
LOG_DIR="/home/hyj/code/MDE_Attack/DeepPhotoStyle_pytorch/log2026/01/log0122/color_4/midu_weight_${MIDU_WEIGHT[0]}_${CONTENT_IMAGE}_${STYLE_IMAGE}_${PAINT_MASK}"
