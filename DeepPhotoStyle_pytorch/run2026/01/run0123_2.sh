...
CONTENT_WEIGHT=(1000 2000 3000 5000 6000 7000 9000 10000)
...
DEVICE=1
NPS_WEIGHT=0.001
COLOR_WEIGHT=(10000000 10000000 10000000 10000000 10000000 10000000 10000000 10000000)
...
LOG_DIR="/home/hyj/code/MDE_Attack/DeepPhotoStyle_pytorch/log2026/01/log0123/color_2/midu_weight_${MIDU_WEIGHT[0]}_${CONTENT_IMAGE}_${STYLE_IMAGE}_${PAINT_MASK}"
...
for i in {0,1,2,3,4,5,6,7}; do
    RESULT_FILE="$LOG_DIR/CONTENT_WEIGHT_${CONTENT_WEIGHT[$i]}_color_weight_${COLOR_WEIGHT[$i]}_${i}.txt"
