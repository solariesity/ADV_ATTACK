...
DEVICE=1
NPS_WEIGHT=0.001
COLOR_WEIGHT=(600000 1000000 2000000 4000000 6000000 10000000 20000000 40000000)
...
LOG_DIR="/home/hyj/code/MDE_Attack/DeepPhotoStyle_pytorch/log2026/01/log0126/color_2/midu_weight_${MIDU_WEIGHT[0]}_${CONTENT_IMAGE}_${STYLE_IMAGE}_${PAINT_MASK}"
