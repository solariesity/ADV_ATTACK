...
DEVICE=1
NPS_WEIGHT=0.001
COLOR_WEIGHT=(500000 500000 500000 500000 500000 500000 500000 500000)
ORIGINAL_WEIGHT=(100 1000 10000 100000 1000000 10000000 100000000 1000000000)
FIXED_LOCATION=1
...
LOG_DIR="/home/hyj/code/MDE_Attack/DeepPhotoStyle_pytorch/log0107/total_2/midu_weight_${MIDU_WEIGHT[0]}_${CONTENT_IMAGE}_${STYLE_IMAGE}_${PAINT_MASK}"
LOG_FILE="$LOG_DIR/original_weight_change_${PAINT_MASK}_${STEPS}.txt"
...
for i in {0,1,2,3,4,5,6,7}; do
    RESULT_FILE="$LOG_DIR/original_weight_${ORIGINAL_WEIGHT[$i]}_${i}.txt"
