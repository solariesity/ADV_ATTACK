...
CONTENT_WEIGHT=(600000 600000 600000 600000 600000 600000 600000 600000)30000
...
DEVICE=1
NPS_WEIGHT=0.001
COLOR_WEIGHT=(2000000 4000000 6000000 8000000 10000000 12000000 14000000 16000000)
...
LOG_DIR="/home/hyj/code/MDE_Attack/DeepPhotoStyle_pytorch/log0116/total_2/midu_weight_${MIDU_WEIGHT[0]}_${CONTENT_IMAGE}_${STYLE_IMAGE}_${PAINT_MASK}"
