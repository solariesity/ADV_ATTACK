...
DEVICE=1
NPS_WEIGHT=0.001
COLOR_WEIGHT=(800000 1000000 1200000 1400000 1600000 1800000 2000000 2200000)
...
LOG_DIR="/home/hyj/code/MDE_Attack/DeepPhotoStyle_pytorch/log0112/total_2/midu_weight_${MIDU_WEIGHT[0]}_${CONTENT_IMAGE}_${STYLE_IMAGE}_${PAINT_MASK}"
