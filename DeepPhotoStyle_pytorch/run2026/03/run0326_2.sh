...
DEVICE=1
NPS_WEIGHT=0.001
COLOR_WEIGHT=(5000000000 1000000000 500000000 100000000 50000000 10000000 5000000 1000000)
...
LOG_DIR="/home/hyj/code/MDE_Attack/DeepPhotoStyle_pytorch/log2026/03/log0326/color_2/midu_weight_${MIDU_WEIGHT[0]}_${CONTENT_IMAGE}_${STYLE_IMAGE}_${PAINT_MASK}"
