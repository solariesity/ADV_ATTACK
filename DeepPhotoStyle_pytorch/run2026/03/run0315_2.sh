...
DEVICE=1
NPS_WEIGHT=0.001
COLOR_WEIGHT=(10000000 30000000 100000000 300000000 1000000000 3000000000 10000000000 30000000000)
...
LOG_DIR="/home/hyj/code/MDE_Attack/DeepPhotoStyle_pytorch/log2026/03/log0315/color_2/midu_weight_${MIDU_WEIGHT[0]}_${CONTENT_IMAGE}_${STYLE_IMAGE}_${PAINT_MASK}"
