...
# 定义日志目录和参数
STYLE_IMAGE="shixi.png" # 试一下shixi
CONTENT_IMAGE="shixi.png"
VEHICLE="BMW.png"
PAINT_MASK="35"
STEPS=300
LEARNING_RATE=(0.45 0.45 0.45 0.45 0.45 0.45 0.45 0.45 0.45)
CONTENT_WEIGHT=(1000 1000 1000 1000 1000 1000 1000 1000)
...
DEVICE=1
NPS_WEIGHT=0.001
COLOR_WEIGHT=(900000 800000 700000 600000 500000 400000 300000 200000)
...
LOG_DIR="/home/hyj/code/MDE_Attack/DeepPhotoStyle_pytorch/log2026/03/log0327/color_4/midu_weight_${MIDU_WEIGHT[0]}_${CONTENT_IMAGE}_${STYLE_IMAGE}_${PAINT_MASK}"
