...
DEVICE=1
NPS_WEIGHT=0.001
COLOR_WEIGHT=(10000000 20000000 40000000 80000000 100000000 200000000 400000000 800000000)
...
LOG_DIR="/home/hyj/code/MDE_Attack/DeepPhotoStyle_pytorch/log2026/03/log0318/color_2/midu_weight_${MIDU_WEIGHT[0]}_${CONTENT_IMAGE}_${STYLE_IMAGE}_${PAINT_MASK}"
