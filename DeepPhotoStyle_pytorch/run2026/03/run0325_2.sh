...
DEVICE=1
NPS_WEIGHT=0.001
COLOR_WEIGHT=(100000000 150000000 200000000 250000000 300000000 350000000 400000000 450000000)
...
LOG_DIR="/home/hyj/code/MDE_Attack/DeepPhotoStyle_pytorch/log2026/03/log0325/color_2/midu_weight_${MIDU_WEIGHT[0]}_${CONTENT_IMAGE}_${STYLE_IMAGE}_${PAINT_MASK}"
