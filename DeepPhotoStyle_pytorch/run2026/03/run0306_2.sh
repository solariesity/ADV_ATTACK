...
CONTENT_WEIGHT=(300 1000 3000 10000 30000 100000 300000 1000000)
...
LOG_DIR="/home/hyj/code/MDE_Attack/DeepPhotoStyle_pytorch/log2026/03/log0306/color_2/midu_weight_${MIDU_WEIGHT[0]}_${CONTENT_IMAGE}_${STYLE_IMAGE}_${PAINT_MASK}"
...
for i in {0,1,2,3,4,5,6,7}; do
    RESULT_FILE="$LOG_DIR/STYLE_WEIGHT_${CONTENT_WEIGHT[$i]}_${i}.txt"
