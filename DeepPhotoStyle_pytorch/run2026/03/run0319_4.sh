...
DEVICE=1
NPS_WEIGHT=0.001
COLOR_WEIGHT=(15000000 15000000 20000000 25000000 30000000 35000000 40000000 45000000)
...
LOG_DIR="/home/hyj/code/MDE_Attack/DeepPhotoStyle_pytorch/log2026/03/log0319/color_4/midu_weight_${MIDU_WEIGHT[0]}_${CONTENT_IMAGE}_${STYLE_IMAGE}_${PAINT_MASK}"
