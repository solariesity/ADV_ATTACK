...
CONTENT_WEIGHT=(300 300 300 300 300 300 300 300)
STYLE_WEIGHT=(20000 20000 20000 20000 20000 20000 20000 20000)
ADV_TYPE="yolo"
ADV_WEIGHT=(1000000 1300000 1600000 2000000 1000000 1000000 1000000 1000000)
...
DEVICE=1
NPS_WEIGHT=0.001
COLOR_WEIGHT=(0 0 0 0 0 0 0 0 100000 100000 100000 100000 100000 100000 100000 100000)
ORIGINAL_WEIGHT=(0 0 0 0 0 0 0 0 1000000 1000000 1000000 1000000 1000000 1000000 1000000 1000000)
FIXED_LOCATION=1
...
LOG_DIR="/home/hyj/code/MDE_Attack/DeepPhotoStyle_pytorch/log2026/03/log0305/color_2/midu_weight_${MIDU_WEIGHT[0]}_${CONTENT_IMAGE}_${STYLE_IMAGE}_${PAINT_MASK}"
...
# 运行多个实验，输出到不同的日志文件
for i in {0,1,2,3}; do
    RESULT_FILE="$LOG_DIR/STYLE_WEIGHT_${STYLE_WEIGHT[$i]}_${i}.txt"
