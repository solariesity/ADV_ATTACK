...
DEVICE=0
NPS_WEIGHT=0.001
COLOR_WEIGHT=(1000 3000 10000 30000 100000 300000 1000000 3000000)
...
LOG_DIR="/home/hyj/code/MDE_Attack/DeepPhotoStyle_pytorch/log2026/03/log0307/color_1/midu_weight_${MIDU_WEIGHT[0]}_${CONTENT_IMAGE}_${STYLE_IMAGE}_${PAINT_MASK}"
