...
# 定义日志目录和参数
STYLE_IMAGE="stop_dir_1.png" # 试一下shixi
CONTENT_IMAGE="shixi.png"
VEHICLE="BMW.png"
PAINT_MASK="32"
STEPS=300
LEARNING_RATE=(0.45 0.45 0.45 0.45 0.45 0.45 0.45 0.45 0.45)
CONTENT_WEIGHT=(300 300 300 300 300 300 300 300)
STYLE_WEIGHT=(20000 200000 2000000 20000000 200000000 2000000000 20000000000 200000000000)
ADV_TYPE="yolo"
...
DEVICE=0
NPS_WEIGHT=0.001
COLOR_WEIGHT=(100000 100000 100000 100000 100000 100000 100000 100000)
...
LOG_DIR="/home/hyj/code/MDE_Attack/DeepPhotoStyle_pytorch/log2026/02/log0205/color_1/midu_weight_${MIDU_WEIGHT[0]}_${CONTENT_IMAGE}_${STYLE_IMAGE}_${PAINT_MASK}"
