...
LEARNING_RATE=(0.45 0.45 0.45 0.45)
...
BASELINE="proposed"
STYLE_LAMBDA=2
END_LEARNING_RATE=(0.01 0.01 0.01 0.01)
DECAY_STEPS=0.7
DECAY_POWER=(2 2 2 2)
DEVICE=1
NPS_WEIGHT=(0.000000001 0.000000001 0.000000001 0.000000001)
COLOR_WEIGHT=(38 38 38 38)
ORIGINAL_WEIGHT=(0 0 0 0)
FIXED_LOCATION=1
CLASS_LAMBDA=(0.0000000001 0.0000000001 0.0000000001 0.0000000001)
MIDU_WEIGHT=(85 85 50 50)


LOG_DIR="/home/hyj/code/MDE_Attack/DeepPhotoStyle_pytorch/log/log2026/04/log0429/midu_scan_${CONTENT_IMAGE}_${STYLE_IMAGE}_${PAINT_MASK}"
LOG_FILE="$LOG_DIR/midu_scan_${PAINT_MASK}_${STEPS}.txt"
...
echo "midu_weight 扫描已完成，请检查日志目录 $LOG_DIR" >> "$LOG_FILE"
