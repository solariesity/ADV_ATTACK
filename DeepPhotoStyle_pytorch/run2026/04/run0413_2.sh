...
ADV_TYPE="yolo"
ADV_WEIGHT=(1000000 1000000 1000000 1000000 1200000 1200000 1200000 1200000)
...
DEVICE=0
NPS_WEIGHT=0.001
COLOR_WEIGHT=(30000000 35000000 40000000 45000000 30000000 35000000 40000000 45000000)
...
LOG_DIR="/home/hyj/code/MDE_Attack/DeepPhotoStyle_pytorch/log/log2026/04/log0413/color_2/midu_weight_${MIDU_WEIGHT[0]}_${CONTENT_IMAGE}_${STYLE_IMAGE}_${PAINT_MASK}"
...
for i in {0,1,2,3,4,5,6,7}; do
    RESULT_FILE="$LOG_DIR/COLOR_WEIGHT_${COLOR_WEIGHT[$i]}_ADV_WEIGHT_${ADV_WEIGHT[$i]}_${i}.txt"
