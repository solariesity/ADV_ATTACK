...
LOG_DIR="/home/hyj/code/MDE_Attack/DeepPhotoStyle_pytorch/log/log2026/04/log0428/repeat_4/repeat_scan_${CONTENT_IMAGE}_${STYLE_IMAGE}_${PAINT_MASK}"
...
echo "所有实验已完成，请检查日志目录 $LOG_DIR" >> "$LOG_FILE"
