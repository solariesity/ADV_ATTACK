...
DEVICE=1
NPS_WEIGHT=0.001
COLOR_WEIGHT=(1000000 10000000 100000000 1000000000)
...
LOG_DIR="/home/hyj/code/MDE_Attack/DeepPhotoStyle_pytorch/log/log2026/04/log0410/color_2/midu_weight_${MIDU_WEIGHT[0]}_${CONTENT_IMAGE}_${STYLE_IMAGE}_${PAINT_MASK}"
