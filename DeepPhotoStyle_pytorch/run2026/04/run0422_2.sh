...
PAINT_MASK="37"
STEPS=400
LEARNING_RATE=(0.28 0.30 0.32 0.34 0.35 0.36 0.38 0.40)
...
COLOR_WEIGHT=(45 45 45 45 45 45 45 45)
...
LOG_DIR="/home/hyj/code/MDE_Attack/DeepPhotoStyle_pytorch/log/log2026/04/log0422/color_2/lr_only_scan_${CONTENT_IMAGE}_${STYLE_IMAGE}_${PAINT_MASK}"
...
# 固定 COLOR_WEIGHT=45、MIDU_WEIGHT=110，只扫描学习率
for i in {0,1,2,3,4,5,6,7}; do
    RESULT_FILE="$LOG_DIR/LR_${LEARNING_RATE[$i]}_COLOR_WEIGHT_${COLOR_WEIGHT[$i]}_MIDU_WEIGHT_${MIDU_WEIGHT[$i]}_${i}.txt"
