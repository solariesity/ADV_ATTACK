...
MIDU_WEIGHT=(30 40 50 60 70 80 90 110)


LOG_DIR="/home/hyj/code/MDE_Attack/DeepPhotoStyle_pytorch/log/log2026/04/log0419/color_2/midu_only_scan_${CONTENT_IMAGE}_${STYLE_IMAGE}_${PAINT_MASK}"
