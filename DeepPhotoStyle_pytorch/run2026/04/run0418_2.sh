...
COLOR_WEIGHT=(35 45 55 65 35 45 55 65)
...
MIDU_WEIGHT=(70 70 70 70 90 90 90 90)


LOG_DIR="/home/hyj/code/MDE_Attack/DeepPhotoStyle_pytorch/log/log2026/04/log0418/xiaochidu_refine_${CONTENT_IMAGE}_${STYLE_IMAGE}_${PAINT_MASK}"
