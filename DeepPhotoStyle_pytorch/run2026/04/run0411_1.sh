...
DEVICE=0
NPS_WEIGHT=0.001
COLOR_WEIGHT=(1000000 5000000 10000000 50000000 100000000 500000000 1000000000 5000000000)
...
LOG_DIR="/home/hyj/code/MDE_Attack/DeepPhotoStyle_pytorch/log/log2026/04/log0411/color_1/midu_weight_${MIDU_WEIGHT[0]}_${CONTENT_IMAGE}_${STYLE_IMAGE}_${PAINT_MASK}"
