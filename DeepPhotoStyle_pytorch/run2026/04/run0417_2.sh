...
ADV_TYPE="yolo"
ADV_WEIGHT=(1)
TV_WEIGHT=(0.0000000000000003)
BATCH_SIZE=6
MASK_WEIGHT=0.001
DEPTH_MODEL="monodepth2"
REALISTIC_WEIGHT=(0.000000000000001)
...
COLOR_WEIGHT=(35)
ORIGINAL_WEIGHT=(0.01)
FIXED_LOCATION=1
CLASS_LAMBDA=(0.0000000001)
MIDU_WEIGHT=(85)


LOG_DIR="/home/hyj/code/MDE_Attack/DeepPhotoStyle_pytorch/log/log2026/04/log0417/fangsuo_all_params_1e6_${CONTENT_IMAGE}_${STYLE_IMAGE}_${PAINT_MASK}"
