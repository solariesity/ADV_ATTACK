...
LOG_DIR="/home/hyj/code/MDE_Attack/DeepPhotoStyle_pytorch/log/log2026/04/log0429/color_scan_${CONTENT_IMAGE}_${STYLE_IMAGE}_${PAINT_MASK}"
LOG_FILE="$LOG_DIR/color_scan_${PAINT_MASK}_${STEPS}.txt"
NEXT_SCRIPT="/home/hyj/code/MDE_Attack/DeepPhotoStyle_pytorch/run2026/04/run0429_4.sh"
...
bash /home/hyj/code/MDE_Attack/DeepPhotoStyle_pytorch/run2026/04/run0429_4.sh
