...
ORIGINAL_WEIGHT=(1000 1000 1000 1000 10000 10000 10000 10000)
FIXED_LOCATION=1
CLASS_LAMBDA=(0.0001 0.0001 0.0001 0.0001 0.0001 0.0001 0.0001 0.0001)
MIDU_WEIGHT=(20000000 50000000 80000000 100000000 20000000 50000000 80000000 100000000)


LOG_DIR="/home/hyj/code/MDE_Attack/DeepPhotoStyle_pytorch/log/log2026/04/log0415/color_2/midu_weight_original_weight_refine_${CONTENT_IMAGE}_${STYLE_IMAGE}_${PAINT_MASK}"
