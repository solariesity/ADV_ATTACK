...
BASELINE="proposed"
STYLE_LAMBDA=2
END_LEARNING_RATE=(0.014 0.014 0.014 0.014 0.014 0.014 0.014 0.014 0.014 0.014 0.014 0.014 0.014 0.014 0.014 0.014)
DECAY_STEPS=0.8
DECAY_POWER=(2 2 2 2 2 2 2 2) # 先快后慢
DEVICE=0
NPS_WEIGHT=0.001
COLOR_WEIGHT=(35000000 35000000 35000000 35000000 35000000 35000000 35000000 35000000)
ORIGINAL_WEIGHT=(1000000 1000000 1000000 1000000 1000000 100000 10000 1000)
FIXED_LOCATION=1
CLASS_LAMBDA=(0.0001 0.0001 0.0001 0.0001 0.0001 0.0001 0.0001 0.0001)
MIDU_WEIGHT=(500000000 50000000 5000000 500000 500000000 500000000 500000000 500000000)


LOG_DIR="/home/hyj/code/MDE_Attack/DeepPhotoStyle_pytorch/log/log2026/04/log0414/color_1/midu_weight_original_weight_small_${CONTENT_IMAGE}_${STYLE_IMAGE}_${PAINT_MASK}"
...
for i in {0,1,2,3,4,5,6,7}; do
    RESULT_FILE="$LOG_DIR/ORIGINAL_WEIGHT_${ORIGINAL_WEIGHT[$i]}_MIDU_WEIGHT_${MIDU_WEIGHT[$i]}_${i}.txt"
