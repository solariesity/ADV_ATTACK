...
# 相比 run0424_2.sh：
# TV_WEIGHT / REALISTIC_WEIGHT / STYLE_WEIGHT / ORIGINAL_WEIGHT / MASK_WEIGHT 同时置 0
# 只跑 2 轮完全相同的重复实验
...
LOG_DIR="/home/hyj/code/MDE_Attack/DeepPhotoStyle_pytorch/log/log2026/04/log0424/color_4/all_zero_terms_repeat_${CONTENT_IMAGE}_${STYLE_IMAGE}_${PAINT_MASK}"
