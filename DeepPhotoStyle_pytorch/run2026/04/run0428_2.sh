...
COLOR_WEIGHT=(38 38 38)
ORIGINAL_WEIGHT=(0 0 0)
FIXED_LOCATION=1
CLASS_LAMBDA=(0.0000000001 0.0000000001 0.0000000001)
MIDU_WEIGHT=(85 85 85)


LOG_DIR="/home/hyj/code/MDE_Attack/DeepPhotoStyle_pytorch/log/log2026/04/log0428/repeat_2/repeat_scan_${CONTENT_IMAGE}_${STYLE_IMAGE}_${PAINT_MASK}"
LOG_FILE="$LOG_DIR/repeat_scan_${PAINT_MASK}_${STEPS}.txt"
...
echo "0428_2 已完成，开始执行 run0428_4.sh" >> "$LOG_FILE"

SCRIPT_DIR="$(cd "$(dirname "$0")" && pwd)"
bash "$SCRIPT_DIR/run0428_4.sh"
