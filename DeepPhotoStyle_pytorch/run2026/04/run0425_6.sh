...
LABEL=("color_scan_35" "color_scan_45" "color_scan_55" "color_scan_70")

LEARNING_RATE=(0.35 0.35 0.35 0.35)
CONTENT_WEIGHT=(0.01 0.01 0.01 0.01)
...
COLOR_WEIGHT=(35 45 55 70)
ORIGINAL_WEIGHT=(0 0 0 0)
FIXED_LOCATION=1
CLASS_LAMBDA=(0.0000000001 0.0000000001 0.0000000001 0.0000000001)
MIDU_WEIGHT=(85 85 85 85)


LOG_DIR="/home/hyj/code/MDE_Attack/DeepPhotoStyle_pytorch/log/log2026/04/log0425/color_6/color_weight_scan_${CONTENT_IMAGE}_${STYLE_IMAGE}_${PAINT_MASK}"
