...
ORIGINAL_WEIGHT=(10000 10000 10000 10000 10000 10000 10000 10000)
FIXED_LOCATION=1
CLASS_LAMBDA=(0.0001 0.0001 0.0001 0.0001 0.0001 0.0001 0.0001 0.0001)
MIDU_WEIGHT=(70000000 75000000 80000000 85000000 90000000 95000000 100000000 110000000)


LOG_DIR="/home/hyj/code/MDE_Attack/DeepPhotoStyle_pytorch/log/log2026/04/log0416/color_2/midu_weight_refine_${CONTENT_IMAGE}_${STYLE_IMAGE}_${PAINT_MASK}"
