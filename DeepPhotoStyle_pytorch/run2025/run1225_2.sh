...
STYLE_WEIGHT=(6000000 6500000 7000000 7500000 8000000 8500000 9000000 9500000)
ADV_TYPE="yolo"
...
LOG_DIR="/home/hyj/code/MDE_Attack/DeepPhotoStyle_pytorch/log1225/total2/midu_weight_${MIDU_WEIGHT[0]}_${CONTENT_IMAGE}_${STYLE_IMAGE}_${PAINT_MASK}"
