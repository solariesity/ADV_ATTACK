...
PAINT_MASK="29"
STEPS=300
LEARNING_RATE=(0.45 0.45 0.45 0.45 0.4 0.45 0.25 0.25 0.25 0.25)
CONTENT_WEIGHT=(3600 10000 30000 100000 3600 3600 3600 3600)
...
MIDU_WEIGHT=(1000 1000 1000 1000)

LOG_DIR="/home/hyj/code/MDE_Attack/DeepPhotoStyle_pytorch/log1109/total2/${CONTENT_IMAGE}_${PAINT_MASK}_${STEPS}"
...
# 运行多个实验，输出到不同的日志文件
for i in {0,1,2,3}; do
    RESULT_FILE="$LOG_DIR/grad_${STYLE_IMAGE}_${MIDU_WEIGHT[$i]}_${LEARNING_RATE[$i]}_${i}.txt"
