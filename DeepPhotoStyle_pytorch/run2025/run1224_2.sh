...
STYLE_WEIGHT=(200000 600000 1000000 2000000 6000000 10000000 20000000 60000000)
ADV_TYPE="yolo"
...
LOG_DIR="/home/hyj/code/MDE_Attack/DeepPhotoStyle_pytorch/log1224/total2/midu_weight_${MIDU_WEIGHT[0]}_${CONTENT_IMAGE}_${PAINT_MASK}"
