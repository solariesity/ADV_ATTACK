...
PAINT_MASK="29"
STEPS=300
LEARNING_RATE=(0.4 0.4 0.4 0.4 0.4 0.45 0.25 0.25 0.25 0.25)
...
LOG_DIR="/home/hyj/code/MDE_Attack/DeepPhotoStyle_pytorch/log1106/total2/${CONTENT_IMAGE}_${PAINT_MASK}_${STEPS}"
