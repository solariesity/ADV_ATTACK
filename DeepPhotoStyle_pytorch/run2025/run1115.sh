...
LOG_DIR="/home/hyj/code/MDE_Attack/DeepPhotoStyle_pytorch/log1115/total/${CONTENT_IMAGE}_${PAINT_MASK}_${STEPS}"
...
# 运行多个实验，输出到不同的日志文件
for i in {0,1,2,3}; do
    RESULT_FILE="$LOG_DIR/fixed_loss_midu_${STYLE_IMAGE}_${MIDU_WEIGHT[$i]}_${MIDU_WEIGHT[$i]}_${i}.txt"
