...
CONTENT_WEIGHT=(25000 26300 27700 29200 30800 32400 34200 36000)
...
LOG_DIR="/home/hyj/code/MDE_Attack/DeepPhotoStyle_pytorch/log1215/total2/midu_weight_${MIDU_WEIGHT[0]}_${CONTENT_IMAGE}_${PAINT_MASK}"
