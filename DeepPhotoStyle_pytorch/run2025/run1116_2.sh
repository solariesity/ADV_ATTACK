...
MIDU_WEIGHT=(30000 100000 300000 1000000)

LOG_DIR="/home/hyj/code/MDE_Attack/DeepPhotoStyle_pytorch/log1116/total2/${CONTENT_IMAGE}_${PAINT_MASK}_${STEPS}"
LOG_FILE="$LOG_DIR/loss_midu_3_${CONTENT_IMAGE}_${PAINT_MASK}_${STEPS}_${LEARNING_RATE}.txt"
...
# 运行多个实验，输出到不同的日志文件
for i in {0,1,2,3}; do
    RESULT_FILE="$LOG_DIR/loss_midu_3_${STYLE_IMAGE}_${MIDU_WEIGHT[$i]}_${MIDU_WEIGHT[$i]}_${i}.txt"
