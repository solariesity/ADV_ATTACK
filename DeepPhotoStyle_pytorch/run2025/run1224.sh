...
CONTENT_WEIGHT=(30000 30000 30000 30000 20000 20000 20000 20000)
...
DEVICE=0
NPS_WEIGHT=0.001
COLOR_WEIGHT=(500000000 500000000 500000000 500000000 500000000 500000000 500000000 500000000)
FIXED_LOCATION=1
CLASS_LAMBDA=(0.0001 0.0001 0.0001 0.0001 0.0001 0.0001 0.0001 0.0001)
MIDU_WEIGHT=(10000 100000 1000000 10000000 10000 100000 1000000 10000000)

LOG_DIR="/home/hyj/code/MDE_Attack/DeepPhotoStyle_pytorch/log1224/total/midu_weight_${MIDU_WEIGHT[0]}_${CONTENT_IMAGE}_${STYLE_IMAGE}_${PAINT_MASK}"
...
# 运行多个实验，输出到不同的日志文件
for i in {0,1,2,3}; do
    RESULT_FILE="$LOG_DIR/color_weight_${COLOR_WEIGHT[$i]}_content_weight_${CONTENT_WEIGHT[$i]}_${i}.txt"
