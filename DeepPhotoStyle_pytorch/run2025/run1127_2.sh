...
MIDU_WEIGHT=(250000000 500000000 750000000 1000000000 1250000000 1500000000)

LOG_DIR="/home/hyj/code/MDE_Attack/DeepPhotoStyle_pytorch/log1127/total2/${CONTENT_IMAGE}_${PAINT_MASK}_${STEPS}"
