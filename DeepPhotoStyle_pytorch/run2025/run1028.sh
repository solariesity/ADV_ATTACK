...
PAINT_MASK="28"
STEPS=300
LEARNING_RATE=(0.3 0.35 0.4 0.45 0.25 0.25 0.25 0.25)
...
LOG_DIR="/home/hyj/code/MDE_Attack/DeepPhotoStyle_pytorch/log1028/al/${CONTENT_IMAGE}_${PAINT_MASK}_${STEPS}"
