...
CONTENT_WEIGHT=(6900 8300 10000 12000 14400 17300 20800 25000)
...
LOG_DIR="/home/hyj/code/MDE_Attack/DeepPhotoStyle_pytorch/log1214/total2/midu_weight_${MIDU_WEIGHT[0]}_${CONTENT_IMAGE}_${PAINT_MASK}"
