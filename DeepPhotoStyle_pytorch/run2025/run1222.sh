...
CONTENT_WEIGHT=(20000 60000 100000 200000 22000 24000 26000 28000)
...
LOG_DIR="/home/hyj/code/MDE_Attack/DeepPhotoStyle_pytorch/log1222/total/midu_weight_${MIDU_WEIGHT[0]}_${CONTENT_IMAGE}_${PAINT_MASK}"
