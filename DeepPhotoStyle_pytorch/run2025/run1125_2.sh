...
PAINT_MASK="32"
STEPS=300
LEARNING_RATE=(0.45 0.45 0.45 0.45 0.45 0.25 0.25 0.25 0.25)
...
MIDU_WEIGHT=(50000000 100000000 250000000 500000000 750000000 1000000000 1250000000 1500000000)

LOG_DIR="/home/hyj/code/MDE_Attack/DeepPhotoStyle_pytorch/log1125/total2/${CONTENT_IMAGE}_${PAINT_MASK}_${STEPS}"
LOG_FILE="$LOG_DIR/noeot_${CONTENT_IMAGE}_${PAINT_MASK}_${STEPS}_${LEARNING_RATE}.txt"
...
for i in {0,1,2,3,4,5,6,7}; do
    RESULT_FILE="$LOG_DIR/noeot_${STYLE_IMAGE}_${MIDU_WEIGHT[$i]}_${MIDU_WEIGHT[$i]}_${i}.txt"
    ...
    wait
    python show_midu.py "$RESULT_FILE"
