...
MIDU_WEIGHT=(1000000 10000000 100000000 1000000000)

LOG_DIR="/home/hyj/code/MDE_Attack/DeepPhotoStyle_pytorch/log1121/total2/${CONTENT_IMAGE}_${PAINT_MASK}_${STEPS}"
