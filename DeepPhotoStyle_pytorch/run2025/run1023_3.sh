...
PAINT_MASK="28"
STEPS=300
LEARNING_RATE=(0.25 0.25 0.25 0.25 0.25 0.25 0.25 0.25 )
...
NPS_WEIGHT=0.001
FIXED_LOCATION=1
CLASS_LAMBDA=(0.00001 0.000001 0.0000001 0.00000001)

LOG_DIR="/home/hyj/code/MDE_Attack/DeepPhotoStyle_pytorch/log1023/adv3/${CONTENT_IMAGE}_${PAINT_MASK}_${STEPS}"
...
# 运行多个实验，输出到不同的日志文件
for i in {0,1,2,3}; do
    RESULT_FILE="$LOG_DIR/grad_${STYLE_IMAGE}_${CLASS_LAMBDA[$i]}_${i}.txt"
