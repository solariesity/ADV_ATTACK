...
DEVICE=1
NPS_WEIGHT=0.001
COLOR_WEIGHT=(700000 700000 70000 700000 900000 1100000 1300000 15000000)
FIXED_LOCATION=1
...
LOG_DIR="/home/hyj/code/MDE_Attack/DeepPhotoStyle_pytorch/log1230/total2/midu_weight_${MIDU_WEIGHT[0]}_${CONTENT_IMAGE}_${STYLE_IMAGE}_${PAINT_MASK}"
