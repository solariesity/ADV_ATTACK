...
DEVICE=0
NPS_WEIGHT=0.001
COLOR_WEIGHT=(10000 100000 1000000 10000000 10000 100000 1000000 10000000)
FIXED_LOCATION=1
...
LOG_DIR="/home/hyj/code/MDE_Attack/DeepPhotoStyle_pytorch/log1225/total/midu_weight_${MIDU_WEIGHT[0]}_${CONTENT_IMAGE}_${STYLE_IMAGE}_${PAINT_MASK}"
