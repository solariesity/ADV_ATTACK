...
MIDU_WEIGHT=(750000000 750000000 750000000 750000000 750000000 750000000 750000000 750000000)

LOG_DIR="/home/hyj/code/MDE_Attack/DeepPhotoStyle_pytorch/log1201/total2/midu_weight_${MIDU_WEIGHT[0]}_${CONTENT_IMAGE}_${PAINT_MASK}"
